...
public class Db_Activity extends SQLiteOpenHelper {
    ...
    public Db_Activity(Context context) {
        ...
        db.execSQL("create table if not exists "+nama_tabel+" (description varchar(50), priority varchar(3))");
    }

    //ketika database dibuat
    @Override
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("create table if not exists "+nama_tabel+" (description varchar(50), priority varchar(3))");
    }
